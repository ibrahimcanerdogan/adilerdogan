...
export const metadata: Metadata = {
  title: 'Hizmetlerimiz',
  description: 'Profesyonel saç kesimi, sakal tıraşı, bakım hizmetleri, saç boyama, masaj, özel tasarım, saç yıkama ve cilt bakımı hizmetlerimiz.',
  openGraph: {
    title: 'Akhisar Gözde Erkek Kuaförü - Hizmetlerimiz',
